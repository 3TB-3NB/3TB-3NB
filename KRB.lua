- [ ] سكربت بليد بال حقوق KRB - Source code
...
- [ ] local Window = Library:NewWindow("سكربت بليد بال")
- [ ] local Section = Window:NewSection(“حقوق KRB")

- [ ] Section:CreateToggle("التفادي التلقائي ", function(value)
...
- [ ] Section:CreateToggle("التفادي التلقائي مطور", function(value)
- [ ] loadstring(game:HttpGet(('https://scriptblox.com/raw/Blade-Ball-Opensource-autoparry-8123'),true))()
- [ ] print(value)
- [ ] end)

- [ ] Section:CreateDropdown("Parry Mod", {"ابذل جهدك", "طبيعي",}, 2, function(text)
- [ ] print(text)
- [ ] end)

- [ ] Section:CreateButton("سبام عشوائي", function()
...
- [ ]     activated, button.Text = not activated, activated and "ايقاف تشغيل" or "تشغيل"
...
- [ ]     game.StarterGui:SetCore("SendNotification", {Title = "سبام يدوي", Text = "Made By SumitScripts", Duration = 5})
- [ ] end
...
- [ ] Section:CreateButton("التقليل من التعليق", function()
- [ ] -- Made by RIP#6666
- [ ] _G.Settings = {
- [ ]     Players = {
...
‏loadstring(game:HttpGet("https://raw.githubusercontent.com/3TB-3NB/3TB-3NB/KRB/ON/TOP/Bladeball.lua/README.md"))()
‏print("Clicked")
‏end)

‏Section:CreateButton("اسرع", function()
...
‏Section:CreateButton("قفز لانهائي", function()
